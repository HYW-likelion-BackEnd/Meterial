$(function (){
   ...
   IMP.init('imp41012444'); //iamport 관리자 페이지에 있는 본인의 가맹점 식별코드(ex. imp00000000)를 입력해야 함!!!

   $('.order-form').on('submit', function (e) { //order_form에 submit 버튼을 눌렀을 때 function을 동작시킴
       ...
       // debug message 추가하기
       var msg = 'checkout.js --- (1) : submit 버튼 클릭됨.';
       console.log(msg);
